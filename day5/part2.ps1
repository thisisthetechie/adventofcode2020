# AdventOfCode 2020 - Day 5 Part 2
...
for ($i = $( $totalSeats | Measure-Object -Minimum).Minimum; $i -lt $($totalSeats | Measure-Object -Maximum).Maximum; $i++ ) { 
    if ( -not $totalSeats.Contains($i) ) { 
